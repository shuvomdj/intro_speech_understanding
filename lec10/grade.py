...
class Test(unittest.TestCase):
    def test_voiced_excitation(self):
        excitation = homework10.voiced_excitation(8000, 100, 8000)
    ...
    def test_resonator(self):
        ...
        for n in range(2,len(y)):
            y[n] = A*x[n] + B*y[n-1] + C*y[n-2]
        resonance = homework10.resonator(x, F, BW, Fs)
    ...
    def test_synthesize_vowel(self):
        ...
        BW4 = 400
        Fs = 8000
        resonance = homework10.synthesize_vowel(duration,F0,F1,F2,F3,F4,BW1,BW2,BW3,BW4,Fs)
